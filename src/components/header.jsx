    ...
    return (
        <header className="bg-white shadow-md p-4 flex justify-between items-center sticky left-0 w-full backdrop-blur-lg top-0 z-50">
           ...
           <div className="gap-4 flex">
            <Link to="/" className="flex items-center justify-center gap-2 group px-3 py-3 bg-gray-200 rounded-full group hover:bg-gray-300  transition-all duration-300">
            <FaHome size={25}/>
           ...
           <Link to="/contact" className="font-medium flex items-center mx-4 group ">Get in Touch<FaArrowRight size={15} className="ml-1 transform transition-transform duration-300 group-hover:translate-x-1.5" /></Link>
        </header>
    )
}
