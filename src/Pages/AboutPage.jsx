    ...
    return ( 
        <main className="min-h-screen justify-center m-0 bg-gray-100">
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-8 mb-8">
                ...
                Founded in 2025, MoveMate started with a simple mission: to make moving stress-free for families and businesses across Kenya. What began as a small team with one truck has grown into a trusted name in the industry.
                </p>
